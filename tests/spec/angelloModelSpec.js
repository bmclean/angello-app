...
// it's best to have one describe block per method on a service, with many tests for each method
describe('Service: angelloModel', function () {
  ...
  describe('#getStatuses', function () {
    ...
    it('should have a status named "To Do"', function () {
      expect(modelService.getStatuses().map(function (status) {return status.name;} )).toContain('To Do');
    });
